...
public class mdCrafting {
    public static Block 
    /* Temportarily removed blocks:
    alloyFurnance, ammoCrafter, metalFormer, metalSeparator, oreMelter, */
    
    duAmmoConstructer, electrolyzer, enrichedUraniumCrafter, fissionFuelInfuser, isotopeSeparator, lavaHeater, 
    plasticRefinery, plutonium239Producer, saltExtractor, slagMixer, stoneMelter, radioactiveLiquefier, radioactiveSeparator, radioactiveSmelter;
